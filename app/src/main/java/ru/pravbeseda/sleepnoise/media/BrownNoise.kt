 ...
 *
 * It no longer sounds anywhere — [LeakyBrownNoise] at [ru.pravbeseda.sleepnoise.catalog.BROWN_NOISE_CUTOFF_HZ]
 * took its slider, because almost all of the walk's level sits below the audible band and the mixer's clamp
 * charged the other channels for it. It stays as the reference `LeakyBrownNoiseTest` measures that difference
 * against.
 */
